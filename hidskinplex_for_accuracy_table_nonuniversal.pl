...
open OUT, ">/mnt/blsm/sarah/targetedstudy/analysis/metaphlan_results/mpileup_results/nonuniversal/for_accuracy_table_nonuniversal.txt" or die "Could not open file for writing\n";
...
open WIN, ">/mnt/blsm/sarah/targetedstudy/analysis/metaphlan_results/mpileup_results/nonuniversal/for_accuracy_table_nonuniversal_wide.txt" or die "Could not open table file for writing\n";
